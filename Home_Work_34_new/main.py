...
app = FastAPI(
    ...
    description="Рефакторинг REST API для интернет-магазина товаров из вселенной Рика и Морти",
    version="1.0.0"
)
...
async def root():
    ...
    masked_key = settings.telegram_bot_api_key[:10] + "***" if len(settings.telegram_bot_api_key) > 10 else "***"
    return {
